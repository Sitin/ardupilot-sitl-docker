...
docker_image := sitin/ardupilot-sitl
...
sitl-help: ## Show SITL help
	@SILENT_START=true docker compose run sitl --help

vehicles: ## Lists SITL vehicles
	@SILENT_START=true docker compose run sitl --list-vehicle || true

mavproxy: ## Starts MAVProxy
...
# Testing
###########################################################
.PHONY: fgfs autotest-init fgfs-patch fgfs-start
